...
class Graph:
    ...
    def createGraph(self, board, id, opponent):
        ...
        #loops and adds imaginary nodes for starting and ending nodes to search through
    ...
    def getHeurestic(self, node):
        ...
        #insentives starting in the middle
...
class Player:
    ...
    def Minimax_value(self, board_state, mmState, depth):
        ...
        # has depth of 3 switches to 2 when board is bigger
        # since we start at 0 if depth is set to 2
        if depth == self.setdepth:
    ...
    def action(self):
        ...
        # to ensure algorithm doesn't time out
        # the depth is set at a lower value on bigger boards
        # or longer games
        if self.n > 9 or self.turncount > 28:
            self.setdepth =2
